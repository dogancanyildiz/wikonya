...
export function UniversitySelector() {
  ...
  return (
    <div className="mb-6">
      <h2 className="font-[Manrope] text-foreground font-bold text-xl sm:text-2xl mb-4 sm:mb-6">
          ...
          >
            <CardContent className="p-5 sm:p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center flex-shrink-0">
              ...
              <p className="font-[Manrope] text-foreground/70 dark:text-muted-foreground text-sm mb-4 leading-relaxed">
              ...
              <div className="space-y-2 pt-4 border-t border-border">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-[Manrope] text-foreground/60 dark:text-muted-foreground text-xs sm:text-sm">
                    {university.location}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-[Manrope] text-primary font-semibold text-xs sm:text-sm">
