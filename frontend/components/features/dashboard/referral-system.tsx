...
export function ReferralSystem() {
  ...
  return (
    <Card className="bg-gradient-to-br from-primary to-primary/80 rounded-xl shadow-lg border-primary">
      <CardHeader>
        ...
        <CardDescription className="font-[Manrope] text-primary-foreground/80">
