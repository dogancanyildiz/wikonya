            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-start gap-4 flex-1">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-primary to-primary/80 rounded-xl flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-[Manrope] text-base sm:text-lg font-bold text-primary">
                          {scholarship.amount}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Badge className="bg-gradient-to-r from-primary to-primary/80 text-white font-[Manrope] font-bold text-sm px-3 py-1.5">
              ...
              <div className="space-y-3">
                {scholarship.applicationProcess.map((step, index) => (
                  <div key={index} className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center flex-shrink-0 font-[Manrope] font-bold text-sm">
                      {index + 1}
                    </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-accent rounded-xl">
                  ...
                  <span className={`font-[Manrope] font-bold text-sm ${
                    scholarship.deadlineDays < 7 ? 'text-red-500' : 'text-primary'
                  }`}>
            ...
            <CardContent className="space-y-4 pt-0">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start gap-2 p-2">
                  ...
                  <span className="font-[Manrope] text-xs text-foreground/70 dark:text-muted-foreground">
