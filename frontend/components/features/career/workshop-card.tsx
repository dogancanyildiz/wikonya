    ...
    <Card className="bg-card rounded-xl shadow-md dark:shadow-lg hover:shadow-lg dark:hover:shadow-xl transition-all overflow-hidden group border border-border">
        ...
        <div className="absolute top-3 sm:top-4 left-3 sm:left-4">
          <div className="bg-primary rounded-2xl overflow-hidden shadow-lg">
            <div className="bg-white px-3 sm:px-4 py-1">
              <span className="font-[Manrope] text-primary block text-center font-extrabold text-[9px] sm:text-[10px] letter-spacing-wide">
                {dateMonth}
              </span>
            </div>
      ...
      <CardContent className="p-4 sm:p-5">
        <div className="mb-2 sm:mb-3">
          <span className="font-[Manrope] text-primary font-bold text-xs sm:text-xs">
            {organizer}
          </span>
        </div>

        <h3 className="font-[Manrope] text-foreground mb-2 sm:mb-3 group-hover:text-primary transition-colors line-clamp-2 min-h-[2.6rem] font-bold text-sm sm:text-base leading-snug">
          {title}
        </h3>
        ...
        <div className="space-y-1.5 sm:space-y-2 mb-3 sm:mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-[Manrope] text-foreground/70 dark:text-muted-foreground font-medium text-xs sm:text-[13px]">
              {time}
            </span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="mb-3 sm:mb-4">
          <div className="flex items-center justify-between mb-1.5 sm:mb-2">
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-[Manrope] text-foreground font-semibold text-xs sm:text-xs">
