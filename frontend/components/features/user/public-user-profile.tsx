              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3">
                    <h1 className="font-[Manrope] text-foreground font-extrabold text-2xl sm:text-3xl lg:text-4xl">
                      {user.name}
                    </h1>
                  ...
                  {user.bio && (
                    <p className="font-[Manrope] text-foreground/70 dark:text-muted-foreground mb-4 leading-relaxed">
                      {user.bio}
                    </p>
                  )}
                  <div className="flex flex-wrap items-center gap-4 text-sm">
                    {user.location && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-[Manrope] text-foreground/70 dark:text-muted-foreground">
                          {user.location}
                        </span>
                      </div>
                    )}
            ...
            <CardContent>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-accent rounded-xl">
                  ...
                  <p className="font-[Manrope] font-extrabold text-2xl text-foreground mb-1">
                    {user.stats.topics}
                  </p>
            ...
            <CardContent>
              <div className="space-y-3">
                {contributions.map((contribution) => (
                  <div key={contribution.id} className="flex items-center justify-between p-3 bg-accent rounded-xl">
                    <div className="flex-1">
            ...
            <CardContent>
              <div className="space-y-3">
                {user.badges.map((badge) => (
                  <div key={badge.id} className="flex items-center gap-3 p-3 bg-accent rounded-xl">
          ...
          <Card className="bg-card rounded-xl shadow-md dark:shadow-lg border border-border">
            ...
            <CardContent>
              <div className="text-center py-4">
                <p className="font-[Manrope] font-extrabold text-4xl text-primary mb-2">
