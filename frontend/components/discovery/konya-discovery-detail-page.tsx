...
export function KonyaDiscoveryDetailPage({ placeId }: { placeId: number }) {
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-4 sm:py-6 md:py-8">
      ...
      {/* Place Image */}
      <div className="relative h-64 sm:h-80 md:h-96 lg:h-[500px] rounded-[20px] overflow-hidden mb-6 sm:mb-8 shadow-lg">
        <Image
          src={place.image}
          alt={place.title}
          fill
        ...
        <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6">
          <div className="px-2 sm:px-3 py-1 sm:py-1.5 bg-[#03624c] rounded-lg inline-block mb-2">
        ...
        <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              <Navigation className="w-5 h-5 sm:w-6 sm:h-6 text-[#03624c]" strokeWidth={2.5} />
              <h3 className="font-[Manrope] text-[#4d4d4d] dark:text-foreground font-extrabold text-lg sm:text-xl md:text-2xl">
                Nasıl Gidilir?
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div>
                <span className="font-[Manrope] text-[#03624c] font-bold text-xs sm:text-[13px] block mb-2">
                  Otobüs ile:
                </span>
                <p className="font-[Manrope] text-[#4d4d4d]/70 dark:text-muted-foreground font-medium text-sm sm:text-base">
      ...
      <section>
        <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              <Calendar className="w-5 h-5 sm:w-6 sm:h-6 text-[#03624c]" strokeWidth={2.5} />
              <h3 className="font-[Manrope] text-[#4d4d4d] dark:text-foreground font-extrabold text-lg sm:text-xl md:text-2xl">
                Ne Zaman Gidilir?
              </h3>
            </div>
