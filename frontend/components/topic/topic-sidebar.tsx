  ...
  return (
    <div className="space-y-4 sm:space-y-6 sticky top-24">
      ...
      <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Users className="w-4 h-4 sm:w-5 sm:h-5 text-[#03624c]" />
        ...
        <CardContent className="space-y-2 sm:space-y-3 pt-0">
          {contributors.map((contributor) => (
            <div
              key={contributor.id}
              className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl hover:shadow-md transition-shadow cursor-pointer"
            >
              <Avatar className="w-8 h-8 sm:w-10 sm:h-10 border-2 border-white dark:border-border">
                <AvatarFallback className="bg-[#03624c] text-white font-[Manrope] font-bold text-[10px] sm:text-xs">
                  {contributor.initials}
                </AvatarFallback>
              </Avatar>
              <div className="flex-1 min-w-0">
                <h4 className="font-[Manrope] text-[#4d4d4d] dark:text-foreground font-bold text-xs sm:text-sm truncate">
                  {contributor.name}
                </h4>
      ...
      <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-[#03624c]" />
            <span className="font-[Manrope] text-[#4d4d4d] dark:text-foreground font-bold text-base sm:text-lg">
              İlgili Konular
            </span>
          </CardTitle>
        ...
        <CardContent className="space-y-2 pt-0">
          {relatedTopics.map((topic) => (
            <div
              key={topic.id}
              className="p-2 sm:p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl hover:bg-[#03624c] hover:text-white dark:hover:bg-[#03624c] transition-all cursor-pointer group"
            >
              <h4 className="font-[Manrope] text-[#4d4d4d] dark:text-foreground group-hover:text-white mb-1 font-semibold text-xs sm:text-sm">
                {topic.title}
              </h4>
              <p className="font-[Manrope] text-[#4d4d4d]/60 dark:text-muted-foreground group-hover:text-white/80 font-medium text-[10px] sm:text-xs">
      ...
      <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <BookOpen className="w-4 h-4 sm:w-5 sm:h-5 text-[#03624c]" />
            <span className="font-[Manrope] text-[#4d4d4d] dark:text-foreground font-bold text-base sm:text-lg">
              Ek Kaynaklar
            </span>
          </CardTitle>
        ...
        <CardContent className="space-y-2 pt-0">
          {resources.map((resource) => (
            <div
              key={resource.id}
              className="flex items-center justify-between p-2 sm:p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl hover:shadow-md transition-shadow cursor-pointer group"
            >
              <div className="flex-1 min-w-0">
                <h4 className="font-[Manrope] text-[#4d4d4d] dark:text-foreground font-semibold text-xs sm:text-sm truncate">
                  {resource.title}
                </h4>
              </div>
              <div className="flex items-center gap-2">
                <span className="px-2 py-1 bg-white dark:bg-card rounded-md font-[Manrope] text-[#03624c] font-bold text-[10px] sm:text-xs">
                  {resource.type}
                </span>
                <ExternalLink className="w-3 h-3 sm:w-4 sm:h-4 text-[#03624c] group-hover:scale-110 transition-transform" />
              </div>
            </div>
          ))}
        </CardContent>
      ...
      {/* Info Box */}
      <Card className="bg-gradient-to-br from-[#03624c] to-[#024d3c] rounded-[20px] text-white shadow-[0_4px_20px_rgba(3,98,76,0.3)] border-0">
        <CardHeader>
