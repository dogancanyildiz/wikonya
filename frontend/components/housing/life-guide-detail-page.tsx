      ...
      <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border overflow-hidden">
        ...
        <div className="relative h-64 sm:h-80 overflow-hidden">
          ...
          <div className="absolute top-4 sm:top-6 left-4 sm:left-6">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#03624c] rounded-xl flex items-center justify-center shadow-lg">
        ...
        <CardContent className="p-6 sm:p-8 md:p-10">
          <div className="mb-6 sm:mb-8">
            <h1 className="font-[Manrope] text-[#4d4d4d] dark:text-foreground mb-3 sm:mb-4 font-extrabold text-2xl sm:text-3xl lg:text-4xl">
              {guide.title}
            </h1>
          ...
          <div className="max-w-none">
            <div className="font-[Manrope] text-[#4d4d4d] dark:text-foreground text-sm sm:text-base md:text-lg leading-relaxed whitespace-pre-line space-y-4">
              {guide.fullContent.split('\n').map((line, index) => {
                // Bold text detection
                if (line.startsWith('**') && line.endsWith('**')) {
                  const boldText = line.slice(2, -2)
                  return (
                    <h3 key={index} className="font-bold text-base sm:text-lg md:text-xl text-[#03624c] dark:text-[#03624c] mt-6 mb-3">
                      {boldText}
                    </h3>
                  )
                }
                ...
                if (line.trim().startsWith('-')) {
                  return (
                    <div key={index} className="flex items-start gap-2 pl-4">
                      <span className="text-[#03624c] mt-2">•</span>
          ...
          <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-gray-200 dark:border-border">
            <div className="flex items-center justify-between">
              <span className="font-[Manrope] text-[#03624c] font-bold text-sm sm:text-base">
