      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
          ...
          <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border overflow-hidden">
            ...
            {/* Thumbnail Gallery */}
            <div className="p-4 sm:p-6 border-t border-gray-100 dark:border-border">
                  ...
                  <button
                    ...
                    className={`relative aspect-square rounded-lg overflow-hidden border-2 transition-all ${
                      selectedImageIndex === index
                        ? 'border-[#03624c] ring-2 ring-[#03624c]/20'
              ...
              <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as typeof activeTab)}>
                ...
                <TabsContent value="info" className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                      <div className="flex items-center gap-3 p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl">
                        <Bed className="w-5 h-5 text-[#03624c]" />
                        <div>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl">
                        <Bath className="w-5 h-5 text-[#03624c]" />
                        <div>
                          <p className="font-[Manrope] font-bold text-sm text-[#4d4d4d] dark:text-foreground">
                            {housing.bathrooms}
                          </p>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl">
                        <Ruler className="w-5 h-5 text-[#03624c]" />
                        <div>
                          <p className="font-[Manrope] font-bold text-sm text-[#4d4d4d] dark:text-foreground">
                            {housing.area}
                          </p>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl">
                        <Eye className="w-5 h-5 text-[#03624c]" />
                        <div>
                          <p className="font-[Manrope] font-bold text-sm text-[#4d4d4d] dark:text-foreground">
                            {housing.views}
                          </p>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      {housing.features.map((feature, index) => {
                        ...
                        return (
                          <div key={index} className="flex items-center gap-2 p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {housing.tags.map((tag, index) => (
                        <Badge key={index} className="bg-[#03624c]/10 dark:bg-[#03624c]/20 text-[#03624c] border-[#03624c]/20 dark:border-[#03624c]/30 font-[Manrope] font-bold text-sm px-3 py-1.5">
                  ...
                  <div>
                    ...
                    <p className="font-[Manrope] text-sm text-[#4d4d4d]/70 dark:text-muted-foreground">
                      Müsaitlik tarihi: <span className="font-bold text-[#03624c]">{new Date(housing.availableFrom).toLocaleDateString('tr-TR', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
                    </p>
                    <p className="font-[Manrope] text-xs text-[#4d4d4d]/60 dark:text-muted-foreground mt-1">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
            ...
            <CardContent className="space-y-4 pt-0">
              <div>
                ...
                <div className="space-y-2 mt-3">
                  <a
                    ...
                    className="flex items-center gap-3 p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl hover:bg-[#03624c]/10 dark:hover:bg-[#03624c]/20 transition-colors group"
                  >
                    <Phone className="w-5 h-5 text-[#03624c] group-hover:scale-110 transition-transform" />
                    <span className="font-[Manrope] font-semibold text-sm text-[#4d4d4d] dark:text-foreground group-hover:text-[#03624c]">
                  ...
                  <a
                    ...
                    className="flex items-center gap-3 p-3 bg-[#f2f4f3] dark:bg-accent rounded-xl hover:bg-[#03624c]/10 dark:hover:bg-[#03624c]/20 transition-colors group"
                  >
                    <Mail className="w-5 h-5 text-[#03624c] group-hover:scale-110 transition-transform" />
                    <span className="font-[Manrope] font-semibold text-sm text-[#4d4d4d] dark:text-foreground group-hover:text-[#03624c]">
                      E-posta Gönder
                    </span>
                  </a>
              ...
              <Button className="w-full bg-[#03624c] hover:bg-[#03624c]/90 font-[Manrope] font-bold">
                Mesaj Gönder
              </Button>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
            ...
            <CardContent className="space-y-3 pt-0">
              <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-border">
                ...
                <span className="font-[Manrope] font-bold text-lg text-[#03624c]">
