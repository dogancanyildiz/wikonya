    ...
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-4 sm:py-6 md:py-8">
      ...
      <div className="mb-6 space-y-4">
        <div className="relative">
          <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#4d4d4d]/60 dark:text-muted-foreground" />
          <Input
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className={`font-[Manrope] font-bold text-xs ${
                sortBy === "newest" ? 'bg-[#03624c] text-white' : ''
              }`}
            >
              Yeni
            </Button>
            <Button
              ...
              size="sm"
              className={`font-[Manrope] font-bold text-xs ${
                sortBy === "popular" ? 'bg-[#03624c] text-white' : ''
              }`}
            >
              Popüler
            </Button>
            <Button
              ...
              size="sm"
              className={`font-[Manrope] font-bold text-xs ${
                sortBy === "trending" ? 'bg-[#03624c] text-white' : ''
              }`}
            >
              Trend
            </Button>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                        ...
                        <Badge className="font-[Manrope] font-semibold text-[#03624c] text-xs sm:text-sm bg-[#f2f4f3] dark:bg-accent">
                          {discussion.category}
                        </Badge>
                      ...
                      <h3 className="font-[Manrope] font-bold text-[#4d4d4d] dark:text-foreground mb-2 group-hover:text-[#03624c] transition-colors text-base sm:text-lg">
                        {discussion.title}
                      </h3>
