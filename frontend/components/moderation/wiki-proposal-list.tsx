  ...
  return (
    <div className="space-y-4">
      {pendingProposals.map((proposal) => (
        <Card key={proposal.id} className="bg-white dark:bg-card rounded-[20px] shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-lg border border-border">
          <CardHeader>
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                <h4 className="font-[Manrope] font-bold text-sm mb-2 text-[#4d4d4d] dark:text-foreground">
                  Mevcut İçerik:
                </h4>
