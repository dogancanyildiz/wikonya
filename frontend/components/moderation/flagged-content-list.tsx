          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <h3 className="font-[Manrope] text-[#4d4d4d] dark:text-foreground font-extrabold text-lg sm:text-xl mt-2">
                  {item.title}
                </h3>
              </div>
            </div>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="bg-[#f2f4f3] dark:bg-accent rounded-xl p-4">
                <p className="font-[Manrope] text-sm text-[#4d4d4d] dark:text-foreground leading-relaxed">
                  {item.content}
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-[Manrope] text-sm font-semibold text-[#4d4d4d] dark:text-foreground">
                    {item.author.name}
                  </p>
