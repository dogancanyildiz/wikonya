            ...
            <CardContent>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {participants.map((participant) => (
                  <div key={participant.id} className="flex items-center gap-2 p-2 bg-[#f2f4f3] dark:bg-accent rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-[Manrope] font-semibold text-xs text-[#4d4d4d] dark:text-foreground truncate">
                        {participant.name}
                      </p>
                      <p className="font-[Manrope] text-[10px] text-[#4d4d4d]/60 dark:text-muted-foreground truncate">
                        {participant.role}
                      </p>
                    </div>
                  </div>
            ...
            <CardContent className="space-y-4">
              {isJoined ? (
                <div className="text-center py-4">
                  ...
                  <p className="font-[Manrope] font-bold text-[#03624c] mb-2">
                  ...
                  <Button
                    ...
                    className={`w-full py-3 font-[Manrope] font-bold ${
                      isFull
                        ...
                        : 'bg-[#03624c] hover:bg-[#03624c]/90 text-white'
                    }`}
                  >
